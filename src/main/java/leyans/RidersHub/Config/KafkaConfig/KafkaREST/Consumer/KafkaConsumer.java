...
public class KafkaConsumer {
    ...
    @KafkaListener(topics = "car", groupId = "riders", containerFactory = "riderKafkaListenerContainerFactory")
    public void consumeCar(String message) {

        System.out.println("Car message received: " + message);
    }

    @KafkaListener(topics = "motor", groupId = "riders", containerFactory = "riderKafkaListenerContainerFactory")
    public void consumeMotor(String message) {
        System.out.println("Motor message received: " + message);
    }

    @KafkaListener(topics = "bike", groupId = "riders", containerFactory = "riderKafkaListenerContainerFactory")
